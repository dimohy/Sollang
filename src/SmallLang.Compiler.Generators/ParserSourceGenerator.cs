...
internal static class ParserEmitter
{
    public static string Emit(GrammarSpec spec)
    {
        ...
        builder.AppendLine("    }");
        builder.AppendLine();
        builder.AppendLine("    private FunctionDeclaration ParseFunctionDeclaration(bool isLocal)");
        builder.AppendLine("    {");
        ...
        builder.AppendLine("        var functionName = QualifyFunctionName(namePath, isLocal);");
        ...
        builder.AppendLine("        }");
        builder.AppendLine("        else if (Match(TokenKind.Arrow, out _))");
        builder.AppendLine("        {");
        ...
        builder.AppendLine("        }");
        builder.AppendLine();
        builder.AppendLine("        return new FunctionDeclaration(functionName, inputName?.Text, inputType, returnType.Text, blockInputName?.Text, blockInputType?.Text, localFunctions, body, blockBody, name.Line, name.Column, isIntrinsic, isStandardLibrary);");
        builder.AppendLine("    }");
        builder.AppendLine();
        ...
        builder.AppendLine();
                ...
                builder.AppendLine("                {");
                builder.AppendLine("                    throw Error(Peek(), \"value-flow target call syntax only allows empty parentheses; use value -> func()\");");
                builder.AppendLine("                }");
                builder.AppendLine();
        ...
        builder.AppendLine("        if (source is not RangeExpression range)");
        builder.AppendLine("        {");
        builder.AppendLine("            throw Error(fold, \"fold expects a range input\");");
        builder.AppendLine("        }");
        builder.AppendLine();
        ...
        builder.AppendLine("        return new FoldExpression(range, initial, accumulator.Text, item.Text, body, fold.Line, fold.Column);");
        builder.AppendLine("    }");
        builder.AppendLine();
        ...
        builder.AppendLine("        if (value is FlowExpression)");
        builder.AppendLine("        {");
        builder.AppendLine("            _index = saved;");
        ...
        builder.AppendLine("    {");
        builder.AppendLine("        // PrimaryExpression = WhenExpression | CallExpression | StringExpression | NumberExpression | NameExpression");
        ...
        builder.AppendLine("    }");
        builder.AppendLine();
        builder.AppendLine("    private WhenExpression ParseSubjectWhenExpression(Expression subject, Token when)");
        builder.AppendLine("    {");
        ...
        builder.AppendLine("    {");
        builder.AppendLine("        // WhenArmBody = Arrow Expression | LeftBrace BlockBody RightBrace");
        builder.AppendLine("        if (Match(TokenKind.Arrow, out var arrow))");
        builder.AppendLine("        {");
