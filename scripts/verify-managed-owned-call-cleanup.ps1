...
$cases = @(
    ...
    @{name='1528-fixed-field-factory';allocations=1},
    @{name='1529-fixed-field-named';allocations=2},
    @{name='1530-fixed-field-stack';allocations=1},
    @{name='1531-fixed-field-owned';allocations=2},
    @{name='1532-fixed-field-region';allocations=2},
