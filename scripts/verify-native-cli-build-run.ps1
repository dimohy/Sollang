...
Write-Host "[native CLI 3/8] Named-input source build."
...
Write-Host "[native CLI 4/8] Contextual-it source build."
...
Write-Host "[native CLI 5/8] Project-directory build."
...
Write-Host "[native CLI 7/8] Run and literal argv forwarding."
...
Write-Host "[native CLI 8/8] Complete standard-library linkage."
...
Write-Host "Native source/project/workspace build/run CLI verification passed (8/8)."
