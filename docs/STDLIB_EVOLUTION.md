...
Regex/search policy, owned Path migration, selfhost closure, and accumulated
Stage2/Stage3 promotion remain pending, so the combined row is still in progress.
