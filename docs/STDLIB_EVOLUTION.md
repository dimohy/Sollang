...
consuming owner recovery. Reactor adapters, bounded transactional read-all, and
asynchronous buffering still require their own implementation and platform
promotion. The implemented portable protocols and their compiler trait
